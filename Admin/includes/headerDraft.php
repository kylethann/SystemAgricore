...
// updateActivityTime($_SESSION['role'], $_SESSION['id'], $pdo);
$settings = getSettings($pdo);

$navBG = $settings['nav_color'];
$navColorMode = $settings['nav_color_mode'];
$webName = $settings['site_name'];
...
<body id="page-top" >
    ...
    <!-- Page Wrapper -->
    <div id="wrapper" style="background-color: #00a300">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion " id="accordionSidebar">
            ...
            <!-- Nav Item - Pages Collapse Menu -->
                ...
                <div id="content-wrapper" class="d-flex flex-column " style="background: #F5F5F1">
