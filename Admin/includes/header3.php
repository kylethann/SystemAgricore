...
<body id="page-top" >
    <div id="wrapper" >
        <ul class="navbar-nav  sidebar sidebar-dark accordion " style="background-color: #1e7145" id="accordionSidebar" >
            <img src="images/logo.png" alt="" class="logo" href="dashboard.php">
        ...
        <!-- Nav Item - Customer Collapse Menu -->
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="clientProfile.php">Client Profile</a>
                        <a class="collapse-item" href="x">Bidding Transaction</a>
        ...
        <!-- Nav Item - Pages Collapse Menu -->
            ...
            <!-- Content Wrapper -->
                ...
                <div id="content-wrapper" class="d-flex flex-column " >
                    <div id="content">
                        <!-- Topbar -->
                        <nav class="navbar navbar-expand navbar-success topbar mb-4 static-top shadow " style="background-color: #1e7145">
                        <!-- <header class="header"> -->
                            ...
                            <!-- <div class="header-user">
                                <div class="user-account">
                                    <a href="profile.php" class="fullName">
                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item dropdown no-arrow right">
                                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                        ...
                                        <!-- <?=$result->fullName; ?> -->
                                        <!-- <?php echo htmlentities($adminResult->fullName);?></span> -->
